	...
	<div class="actions">
		<ul>
			<!--
                         ...
                         <li><?php echo $this->Html->link(sprintf(__("New %s", true), Inflector::humanize(Inflector::underscore($_alias))), $_details['controller'] . '/add/' . $instituicao['Instituicao']['id']);?> </li>
                         -->
                         <li><?php echo $this->Html->link(sprintf(__("New %s", true), Inflector::humanize(Inflector::underscore($_alias))), array('controller' => $_details['controller'], 'action' => 'add/' . $instituicao['Instituicao']['id']));?> </li>
                </ul>
	</div>
</div>
<?php endforeach;?>