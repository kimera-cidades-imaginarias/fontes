...
<?php
	if (isset($_POST['submitted'])) { 
		...
		$sql = "INSERT INTO `pecas` ( `titulo` ,  `imagem01` ,  `imagem02` ,  `publicado`  ) VALUES(  '{$_POST['titulo']}' ,  '{$imagem01}' ,  '{$imagem02}' , '{$_POST['publicado']}'  ) "; 
...
<form action='' method='POST' enctype="multipart/form-data"> 
	<p><b>Titulo:</b><br /><input type='text' name='titulo' class="input-xxlarge" /> </p>
	<p><b>Imagem01:</b><br /><input type='file' name='imagem01' id="imagem01" /> </p>
	<p><b>Imagem02:</b><br /><input type='file' name='imagem02' id="imagem02" /> </p>
	<p><input type="checkbox" name="publicado" value="1"><b> Publicado</b></p>
